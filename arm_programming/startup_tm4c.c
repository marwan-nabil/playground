...
/* definitions for fault interrupt handlers */

__stackless void HardFault_Handler(void)
{
    assert_failed("HardFault.log", __LINE__);
}

__stackless void NMI_Handler(void)
{
    assert_failed("NMI.log", __LINE__);
}

__stackless void MemManage_Handler(void)
{
    assert_failed("MemManage.log", __LINE__);
}

__stackless void BusFault_Handler(void)
{
    assert_failed("BusFault.log", __LINE__);
}

__stackless void UsageFault_Handler(void)
{
    assert_failed("UsageFault.log", __LINE__);
}
...
{
    assert_failed("unused.log", __LINE__);
}
